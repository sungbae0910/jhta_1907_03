...
public class ScoreInput extends JPanel {
	...
	public ScoreInput(JLabel a) {
		this(); //매개변수가 없는 기본생성자 호출, 항상 첫줄에 위치해야함
		this.status=a;
	}
	...
	private JLabel getLblNewLabel() {
		if (lblNewLabel == null) {
			...
			lblNewLabel.setFont(new Font("돋움체", Font.PLAIN, 18));
		...
		if (btnNewButton == null) {
			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
						...
						StudentApp.cnt++;
						status.setText(StudentApp.cnt+"번째 성적이 입력되었습니다.");
						snos.setText("");
						namea.setText("");
						score.setText("");
				}
